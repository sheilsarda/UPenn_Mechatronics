...
void handleWallFollow()
{
  ...
  int rightf = digitalRead(22);
  int rightb = digitalRead(22);
  int frontr = digitalRead(23);
  int frontl = digitalRead(23);
  int leftf = digitalRead(22);
  int leftb = digitalRead(22);
  int backr = digitalRead(23);
  int backl = digitalRead(23);

  int delay_bounce = 2000; //how long (ms) to turn left after the right button is pressed
