...
/*
 * Find closest target freq, set  CW parameters and return actual freq
 *
*/
...
int step_target=0, divi_target=0;
  ...
  //From experiments:  f=125.6*step/(div+1)  (my experiments say 122.7)
 
    // check all combinations of step and divi to get the best guess:
    for (int step=1;step<2000; step++) {
      for (int divi=0; divi<sinePrecision; divi++) {
        f=122.7*(double)step/(double)(divi+1);
